...
using CrudDapper8.Services;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using System.Runtime.CompilerServices;

namespace CrudDapper8.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        [HttpDelete]
        public async Task<IActionResult> RemoverUsuario(int usuatioId)
        {
            var usuarios = await _usuarioInterface.RemoverUsuario(usuatioId);
